...
export default class AbstractReader {
	 ...
	 * @returns {Promise<module:@ui5/fs/AbstractReader>}  Promise resolving with filter instance
	 */
	 ...
	 * @returns {Promise<module:@ui5/fs/AbstractReader>} Promise resolving with reader instance
	 */
