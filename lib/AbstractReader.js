...
// TODO: Cyclic dependency between AbstractReader and Filter, Transformer and Link.
// Not possible to migrate the require statements to dynamic import statement without
// making APIs 'flatten', 'filter' and 'transform' async
...
class AbstractReader {
	 ...
	 * @returns {Promise<module:@ui5/fs.reader.Filter>}  Promise resolving with filter instance
	 */
	 ...
	 * @returns {Promise<module:@ui5/fs.reader.Transformer>} Promise resolving with transformer instance
	 */
	 ...
	 * @returns {Promise<module:@ui5/fs.reader.AbstractReader>} Promise resolving with reader instance
	 */
