...
class Link extends AbstractReader {
	...
	*
	* @public
	* @callback module:@ui5/fs.readers.Link~getResource
	...
	*/
	 ...
	 * @param {string} parameters.pathMapping
	 */
	...
	async _byGlob(patterns, options, trace) {
		...
		patterns = patterns.map((pattern) => {
			...
			return resourceFactory._prefixGlobPattern(pattern, this._pathMapping.targetPath);
		});
