 ...
 */
class ReaderTransformer extends AbstractReader {
	/**
	* Filter callback
	*
	* @public
	* @callback module:@ui5/fs.ReaderTransformer~callback
	...
	*/
	 ...
	 * @param {module:@ui5/fs.ReaderTransformer~callback} parameters.callback
...
module.exports = ReaderTransformer;
